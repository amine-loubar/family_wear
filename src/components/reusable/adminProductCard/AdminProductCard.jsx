...
import adminProductCardCss from './AdminProductCard.module.css'

const AdminProductCard = (props) => {
    return (
        <>
            <div className={adminProductCardCss.cartCard}>
                <div className={adminProductCardCss.image}>
                    <img src={props.src} alt={props.alt} />
                </div>
                <div className={adminProductCardCss.info}>
                    <div className={adminProductCardCss.infoLeft}>
                        <div className={adminProductCardCss.infoLeftTop}>
                            <div className={adminProductCardCss.productName}>{props.name}</div>
                            <div className={adminProductCardCss.productPrice}>{props.description}</div>
                        </div>
                        <div className={adminProductCardCss.infoLeftBottom}>
                            $ <span>{props.price}</span>
                        </div>
                    </div>
                    <div className={adminProductCardCss.infoRight}>
                        <div className={adminProductCardCss.infoRightTop}><svg width="22" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
